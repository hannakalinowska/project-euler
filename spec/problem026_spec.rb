...
describe '#recurring?(string, substring)' do
  specify {recurring?('111', '1').should be_truthy}
  specify {recurring?('123123123', '123').should be_truthy}
  specify {recurring?('1123123123', '123').should be_truthy}
  specify {recurring?('1231231', '123').should be_truthy}
  specify {recurring?('', '').should be_truthy}

  specify {recurring?('123', '1').should be_falsey}
  specify {recurring?('1231234', '123').should be_falsey}
  specify {recurring?('', '123').should be_falsey}
end

describe '#find_recurrence' do
  it "returns recurring string" do
    pending "broke this on upgrade"
